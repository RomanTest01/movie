...
public class ProductManagerTest {
    ...
    public void findMoreFilms() {
        ...
        String[] expected = {"Kino 6", "Kino 5", "Kino 4", "Kino 3", "Kino 2"};
        String[] actual = manager.findLast();
    ...
    @Test
    public void findMoreFilmsLimitAvto() {
        ProductManager manager = new ProductManager();
        manager.saveMovies("Kino 1");
        manager.saveMovies("Kino 2");
        manager.saveMovies("Kino 3");
        ...
        String[] expected = {"Kino 9", "Kino 8", "Kino 7", "Kino 6", "Kino 5"};
        String[] actual = manager.findLast();
